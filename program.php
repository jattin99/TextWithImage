...
<?php
  ...
  $output = "output/outputimage1.jpg";
  ...
  $font = "font\Bright beauty normal.ttf";
  //text you want to display on the  image
  $text="Hey!, I am Jattin";
